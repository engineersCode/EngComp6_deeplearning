...
def interact_polyreg(max_degree, x, y, regularized=False):
    """
    The function to plot polynomial linear regression.
    
    Args:
        max_degree: Max polynomial degree.
        x,y: 1D Training data.
        regularized: Whether to add l2-norm regularization term in loss. Default to False.
    """
